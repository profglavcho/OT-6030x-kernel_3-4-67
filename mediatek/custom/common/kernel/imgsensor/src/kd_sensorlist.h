...
UINT32 OV8850DW9714_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 OV5647AMIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
#if defined(OV8850SUNNY_MIPI_RAW)
    {OV8850SUNNY_SENSOR_ID, SENSOR_DRVNAME_OV8850SUNNY_MIPI_RAW, OV8850SUNNY_MIPI_RAW_SensorInit}, 
#endif
#if defined(OV8850DW9714_MIPI_RAW)
    {OV8850DW9714_SENSOR_ID, SENSOR_DRVNAME_OV8850DW9714_MIPI_RAW, OV8850DW9714_MIPI_RAW_SensorInit}, 
#endif 
#if defined(S5K4E1FX_MIPI_RAW)
    {S5K4E1FX_SENSOR_ID, SENSOR_DRVNAME_S5K4E1FX_MIPI_RAW, S5K4E1FX_MIPI_RAW_SensorInit}, 
#endif

#if defined(S5K5CAGX_MIPI_YUV)
...
#if defined(OV5647A_MIPI_RAW)
    {OV5647AMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5647AMIPI_RAW, OV5647AMIPISensorInit}, 
#endif
